...
// v1.9.6 改善 - 息継ぎ対策: 無音タイマー延長（5秒/9秒）でSTTの自然な息継ぎ吸収を活用
...
class VoiceController {
  constructor() {
    ...
    // v1.9.6改善 - STTの息継ぎ吸収を活用するため少し延長
    this._SILENCE_DELAY = 5000;           // 通常: 5秒
    this._SILENCE_DELAY_HANDSFREE = 9000; // ハンズフリー/常時リスニング: 9秒
    // 最後に受け取ったテキスト（タイマー用）
    this._lastText = '';
    // v1.8追加: STT即終了リトライ用
